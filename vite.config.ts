  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "assets/js/admin-downloads-manager-r15.js", destination: "assets/js/admin-downloads-manager-r15.js" },
        { source: "assets/js/admin-downloads-manager-r14.js", destination: "assets/js/admin-downloads-manager-r15.js" },
        ...
        { source: "assets/js/admin-partners-manager-r15.js", destination: "assets/js/admin-partners-manager-r15.js" },
        { source: "assets/js/admin-partners-manager-r14.js", destination: "assets/js/admin-partners-manager-r15.js" },
