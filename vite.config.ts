  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "assets/js/admin-downloads-manager-r1.js", destination: "assets/js/admin-downloads-manager-r10.js" },
        { source: "assets/js/admin-downloads-manager-r2.js", destination: "assets/js/admin-downloads-manager-r10.js" },
        { source: "assets/js/admin-downloads-manager-r3.js", destination: "assets/js/admin-downloads-manager-r10.js" },
        { source: "assets/js/admin-downloads-manager-r4.js", destination: "assets/js/admin-downloads-manager-r10.js" },
