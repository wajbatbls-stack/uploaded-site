  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "assets/js/site-app-r28.js", destination: "assets/js/site-app-r28.js" },
        ...
        { source: "assets/js/admin-partners-manager-r7.js", destination: "assets/js/admin-partners-manager-r7.js" },
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "js/site-app-r28": path.resolve(import.meta.dirname, "client/public/assets/js/site-app-r28.js"),
