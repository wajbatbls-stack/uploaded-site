...
(function () {
  ...
  if (!document.getElementById("dl10-css")) {
    ...
    css.textContent = `
      ...
      .dfa17-backdrop{position:fixed;inset:0;background:radial-gradient(ellipse at center,rgba(11,18,38,.62),rgba(11,18,38,.78));backdrop-filter:blur(6px);z-index:85;animation:dl10-fade .24s cubic-bezier(.23,1,.32,1)}
      .dfa17-card{position:relative;width:100%;max-width:520px;background:#fff;border-radius:20px;box-shadow:0 30px 80px rgba(11,18,38,.38);display:flex;flex-direction:column;max-height:min(88vh,780px);overflow:hidden}
      .dfa17-head{position:relative;overflow:hidden;padding:26px 24px 24px;background:linear-gradient(130deg,#0b1226 0%,#1a1455 45%,#3d32c8 80%,#7c3aed 100%)}
      .dfa17-orb{position:absolute;border-radius:50%;filter:blur(30px);opacity:.75;pointer-events:none}
      .dfa17-orb-1{width:130px;height:130px;background:#7c3aed;top:-50px;left:-30px;animation:dfa17-orb1 7s ease-in-out infinite}
      .dfa17-orb-2{width:160px;height:160px;background:#0ea5e9;bottom:-70px;right:-40px;opacity:.5;animation:dfa17-orb2 9s ease-in-out infinite}
      .dfa17-head-inner{position:relative;display:flex;flex-direction:column;gap:7px}
      .dfa17-badge{align-self:flex-start;background:rgba(255,255,255,.16);color:#fff;font-size:11.5px;font-weight:800;padding:5px 12px;border-radius:999px;backdrop-filter:blur(5px);border:1px solid rgba(255,255,255,.22);box-shadow:0 4px 14px rgba(0,0,0,.18)}
      .dfa17-head h3{margin:4px 0 0;font-size:19px;font-weight:900;color:#fff;letter-spacing:-.3px}
      .dfa17-head p{margin:0;font-size:13px;color:rgba(255,255,255,.85);line-height:1.6}
      .dfa17-x{position:absolute;top:14px;left:14px;background:rgba(255,255,255,.2);border:1px solid rgba(255,255,255,.28);color:#fff;width:34px;height:34px;border-radius:11px;font-size:14px;cursor:pointer;backdrop-filter:blur(5px);transition:background .15s,transform .15s;z-index:2}
      ...
      .dfa17-field label{display:block;font-size:12.5px;font-weight:800;color:#0c1a33;margin-bottom:6px}
      ...
      .dfa17-btn{font-family:inherit;font-size:13px;font-weight:900;border-radius:12px;padding:12px 22px;cursor:pointer;transition:transform .14s cubic-bezier(.23,1,.32,1),background .15s,opacity .15s,box-shadow .15s;border:none}
