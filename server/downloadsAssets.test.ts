...
describe("أصول قسم إدارة التحميلات الحديث", () => {
  ...
  it("يحمل تطبيق الزائر المبصّم site-app-r19 ويعيد رسم صفحة التحميلات بعد التحميل الديناميكي", () => {
    ...
    expect(indexHtml).toContain("site-app-r22.js");
    expect(projectFile("client/public/assets/js/site-app-r22.js")).toContain("loadSiteDownloads()"), expect(projectFile("client/public/assets/js/site-app-r22.js")).toContain("location.hash.startsWith(\"#/downloads\")");
    expect(projectFile("client/public/assets/js/site-app-r22.js")).not.toContain("site-app-r11.js");
  });
