  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "assets/js/site-app-r29.js", destination: "assets/js/site-app-r29.js" },
        ...
        { source: "assets/js/admin-partners-manager-r8.js", destination: "assets/js/admin-partners-manager-r8.js" },
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "js/site-app-r29": path.resolve(import.meta.dirname, "client/public/assets/js/site-app-r29.js"),
