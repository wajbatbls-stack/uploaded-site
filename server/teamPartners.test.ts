...
describe("أقسام الفريق الإداري وشركاء النجاح (إدارة + عرض الزائر)", () => {
  ...
  it("يشحن مديرَي الإدارة في صفحتي المالك ويتيح تركيبهما داخل مساحة العمل", () => {
    ...
    expect(adminHtml).toContain("admin-partners-manager-r1.js");
    expect(dashboard).toContain("admin-team-manager-r1.js");
    expect(dashboard).toContain("admin-partners-manager-r1.js");
    const app = projectFile("client/public/assets/js/admin-app-r26.js");
  ...
  it("يدعم رفع الصور من الجهاز داخل مديرَي الفريق والشركاء", () => {
    ...
    const partners = projectFile("client/public/assets/js/admin-partners-manager-r1.js");
