...
export const partners = mysqlTable("partners", {
  ...
  shape: varchar("shape", { length: 40 }).default("card").notNull(),
  accentColor: varchar("accentColor", { length: 12 }).default("#4966d6"),
  textColor: varchar("textColor", { length: 12 }).default("#ffffff"),
  backgroundColor: varchar("backgroundColor", { length: 12 }).default("#eef1f8"),
  borderColor: varchar("borderColor", { length: 12 }),
