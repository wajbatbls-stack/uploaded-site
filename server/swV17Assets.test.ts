...
describe("SW v20 purgex mechanism", () => {
  it("sw-purgex-v20.js wipes caches and redirects stale bundles to their current versions without caching", () => {
    expect(sw).toContain("v20-purgex");
    expect(sw).toContain("sw-kill-me");
    expect(sw).toContain("wp-purge-now");
    expect(sw).toContain("skipWaiting");
    expect(sw).toContain('"/assets/js/admin-downloads-manager-r19.js"');
    expect(sw).toContain('"/assets/js/admin-downloads-manager-r20.js"');
    expect(sw).toContain('"/assets/js/site-app-r33.js"');
    expect(sw).toContain('"/assets/js/site-app-r36.js"');
