  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "assets/js/site-app-r21.js", destination: "assets/js/site-app-r21.js" },
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "js/site-app-r21": path.resolve(import.meta.dirname, "client/public/assets/js/site-app-r21.js"),
