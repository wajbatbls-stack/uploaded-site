...
describe("public visitor image removal", () => {
  it("loads the image-free public application release from both visitor entries", () => {
    expect(publicEntry).toContain("site-app-r43.js?v=sv55-read-only-library");
    expect(devEntry).toContain("site-app-r43.js?v=sv55-read-only-library");
    expect(extension).toContain('import "./site-app-r47.js"');
  });
