  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "assets/js/admin-structured-editor-r5.js", destination: "assets/js/admin-structured-editor-r5.js" },
        ...
        { source: "assets/js/admin-downloads-manager-r3.js", destination: "assets/js/admin-downloads-manager-r3.js" },
        { source: "assets/js/admin-downloads-manager-r4.js", destination: "assets/js/admin-downloads-manager-r4.js" },
