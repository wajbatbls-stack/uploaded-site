    ...
    formSection(form) {
      return `<article class="item-row item-editor">
        <div class="editor-fields">
          ...
          <label><span>رابط موقع الجامعة (الموقع الرسمي)</span><input type="text" dir="ltr" maxlength="512" value="${this.esc(form.link || "")}" placeholder="https://example.edu.sa" data-partner-prop="link" /></label>
