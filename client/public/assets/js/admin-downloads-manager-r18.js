...
(function () {
  ...
  if (!document.getElementById("dl10-css")) {
    ...
    css.textContent = `
      ...
      .dfa17-backdrop{position:fixed;inset:0;background:radial-gradient(ellipse at center,rgba(11,18,38,.34),rgba(11,18,38,.5));backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);z-index:85;animation:dl10-fade .24s cubic-bezier(.23,1,.32,1)}
      ...
      .dfa17-orb{position:absolute;border-radius:50%;filter:blur(30px);opacity:.5;pointer-events:none}
      ...
      .dfa17-head p{margin:0;font-size:13px;color:rgba(255,255,255,.92);line-height:1.6}
