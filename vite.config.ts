  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "assets/js/site-app-r27.js", destination: "assets/js/site-app-r27.js" },
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "js/site-app-r27": path.resolve(import.meta.dirname, "client/public/assets/js/site-app-r27.js"),
