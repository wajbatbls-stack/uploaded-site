  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "assets/js/admin-structured-editor-r4.js", destination: "assets/js/admin-structured-editor-r3.js" },
        ...
        { source: "assets/js/site-app-r20.js", destination: "assets/js/site-app-r20.js" },
        { source: "assets/js/site-app-r23.js", destination: "assets/js/site-app-r23.js" },
        ...
        { source: "assets/js/admin-partners-manager-r6.js", destination: "assets/js/admin-partners-manager-r6.js" },
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "js/site-app-r20": path.resolve(import.meta.dirname, "client/public/assets/js/site-app-r20.js"),
        "js/site-app-r22": path.resolve(import.meta.dirname, "client/public/assets/js/site-app-r23.js"),
