(function () {
  ...
  const DEFAULT = {
    ...
    sections: [
      { id: "hero", label: "Hero", visible: true }, { id: "stats", label: "الإحصائيات", visible: false }, { id: "services", label: "الخدمات", visible: false }, { id: "features", label: "المميزات", visible: false }, { id: "cta", label: "الدعوة لاتخاذ إجراء", visible: false },
    ],
    stats: [],
  ...
  const current = () => merge(DEFAULT, getSettings().homePageConfig || {});
  let draft = null;
