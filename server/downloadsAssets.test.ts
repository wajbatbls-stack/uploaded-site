...
describe("أصول قسم إدارة التحميلات الحديث", () => {
  ...
  it("يحمل تطبيق الزائر المبصّم site-app-r17 ويعيد رسم صفحة التحميلات بعد التحميل الديناميكي", () => {
    const indexHtml = projectFile("client/public/index.html");
    expect(indexHtml).toContain("site-app-r17.js");
    expect(projectFile("client/public/assets/js/site-app-r17.js")).toContain("loadSiteDownloads()"), expect(projectFile("client/public/assets/js/site-app-r17.js")).toContain("location.hash.startsWith(\"#/downloads\")");
    expect(projectFile("client/public/assets/js/site-app-r17.js")).not.toContain("site-app-r11.js");
  });
