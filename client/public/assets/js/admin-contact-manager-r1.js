...
(function () {
  ...
  const API = {
    list: "/api/trpc/contact.list",
    publicList: "/api/trpc/contact.publicList",
    create: "/api/trpc/contact.createChannel",
    update: "/api/trpc/contact.updateChannel",
    remove: "/api/trpc/contact.deleteChannel",
    visibility: "/api/trpc/contact.setVisibility",
    move: "/api/trpc/contact.move",
