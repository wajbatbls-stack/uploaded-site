  ...
  return {
    ...
    closeBundle() {
      ...
      const files = [
        ...
        { source: "admin-sv25.html", destination: "admin-sv25.html" },
        ...
        { source: "assets/js/admin-homepage-manager-r2.js", destination: "assets/js/admin-homepage-manager-r2.js" },
        ...
        { source: "assets/js/site-app-r40.js", destination: "assets/js/site-app-r40.js" },
        { source: "assets/js/site-app-r41.js", destination: "assets/js/site-app-r41.js" },
        { source: "assets/js/site-app-r42.js", destination: "assets/js/site-app-r42.js" },
        { source: "assets/js/site-app-r43.js", destination: "assets/js/site-app-r43.js" },
        ...
        { source: "assets/js/site-app-r48.js", destination: "assets/js/site-app-r48.js" },
        { source: "assets/js/site-app-r49.js", destination: "assets/js/site-app-r49.js" },
        { source: "assets/js/site-app-r50.js", destination: "assets/js/site-app-r50.js" },
        { source: "assets/js/site-app-r51.js", destination: "assets/js/site-app-r51.js" },
        ...
        { source: "assets/js/admin-app-r31.js", destination: "assets/js/admin-app-r31.js" },
        { source: "assets/js/admin-app-r32.js", destination: "assets/js/admin-app-r32.js" },

        { source: "assets/js/admin-partners-manager-r17.js", destination: "assets/js/admin-partners-manager-r17.js" },
        { source: "assets/js/admin-partners-manager-r18.js", destination: "assets/js/admin-partners-manager-r18.js" },
        ...
        { source: "assets/css/site-pages-r1.css", destination: "assets/css/site-pages-r1.css" },
        { source: "assets/css/site-downloads-assignment-r1.css", destination: "assets/css/site-downloads-assignment-r1.css" },
        { source: "assets/css/site-downloads-r2.css", destination: "assets/css/site-downloads-r2.css" },
        { source: "assets/css/site-contact-blog-faq-r1.css", destination: "assets/css/site-contact-blog-faq-r1.css" },
        { source: "assets/css/site-contact-blog-faq-r2.css", destination: "assets/css/site-contact-blog-faq-r2.css" },
        { source: "assets/css/site-contact-blog-faq-r3.css", destination: "assets/css/site-contact-blog-faq-r3.css" },
        { source: "assets/css/site-contact-blog-faq-r4.css", destination: "assets/css/site-contact-blog-faq-r4.css" },
        { source: "assets/css/site-contact-blog-faq-r5.css", destination: "assets/css/site-contact-blog-faq-r5.css" },
        ...
        { source: "assets/css/site-home-r37.css", destination: "assets/css/site-home-r37.css" },
        { source: "assets/css/site-home-r38.css", destination: "assets/css/site-home-r38.css" },
        { source: "assets/css/site-home-r39.css", destination: "assets/css/site-home-r39.css" },
        { source: "assets/css/site-home-r40.css", destination: "assets/css/site-home-r40.css" },
        { source: "assets/css/site-subscriptions-r1.css", destination: "assets/css/site-subscriptions-r1.css" },
        { source: "assets/css/site-subscriptions-r2.css", destination: "assets/css/site-subscriptions-r2.css" },
        { source: "assets/css/site-subscriptions-r3.css", destination: "assets/css/site-subscriptions-r3.css" },
        { source: "assets/css/admin-shell-r32.css", destination: "assets/css/admin-shell-r32.css" },
        { source: "assets/css/admin-shell-r33.css", destination: "assets/css/admin-shell-r33.css" },
        { source: "assets/css/admin-shell-r34.css", destination: "assets/css/admin-shell-r34.css" },
        { source: "assets/css/admin-plans-r1.css", destination: "assets/css/admin-plans-r1.css" },
...
function publishVersionedEntryAssets(): Plugin {
  ...
  const entries = [
    ...
    { source: "js/site-app-r42.js", destination: "js/site-app-r42.js" },
    { source: "js/site-app-r43.js", destination: "js/site-app-r43.js" },
